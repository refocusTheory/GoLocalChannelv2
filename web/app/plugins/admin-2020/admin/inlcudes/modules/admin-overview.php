...
class Uipress_module_overview
{
	...
	public function get_settings_options(){
		...
		$temp['description'] = __("Any role or user chosen here will be able to edit the overview page. If none are chosen it will fall back to administrators only",'admin2020');
		$temp['type'] = 'user-role-select';
	...
	*/
	...
	public function build_overview_data(){
		...
		$a2020_options = $this->utils->get_module_option('Uipress_module_overview');
		if(isset($a2020_options['dashcards'])){
			$tempcards = $a2020_options['dashcards'];
